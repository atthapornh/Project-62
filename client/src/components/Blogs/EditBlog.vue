<template>
  <div>
    ...
    <form class="box1" v-on:submit.prevent="editBlog">
      ...
      <p> วันที่ : <input type="date" required class="form-control" v-model="blog.dates" /></p>
      
      <p> เวลา: <input type="time" required class="form-control" v-model="blog.times" /></p>
