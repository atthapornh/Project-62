...
<hr>
    <p><b-button pill variant="success" v-on:click="navigateTo('/blog/create')"> จองคิว </b-button></p>
...
<br>
    <div class="box1" v-for="blog in blogs" v-bind:key="blog.id">
      ...
      <hr><p>
        <b-button pill variant="primary" v-on:click="navigateTo('blog/'+blog.id)"> ดูข้อมูลการจอง </b-button>
